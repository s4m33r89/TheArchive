...
if ($result->num_rows > 0) {
    ...
    $tableHtml .= "<tr><td colspan='4'>No TV series found</td></tr>";
}
...
if ($page > 1) {
    $paginationHtml .= '<a href="javascript:searchTVSeries(1)">First</a>
                        <a href="javascript:searchTVSeries(' . ($page - 1) . ')">Previous</a>';
}
if ($page < $total_pages) {
    $paginationHtml .= '<a href="javascript:searchTVSeries(' . ($page + 1) . ')">Next</a>
                        <a href="javascript:searchTVSeries(' . $total_pages . ')">Last</a>';
}
